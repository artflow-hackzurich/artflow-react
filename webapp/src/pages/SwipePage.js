...
function SwipePage() {
  ...
  const sampleArtworks = [
    { id: 1, title: 'Medium Still Life', year: 1953, desc: MediumStillLife, artist: sampleArtists[0], imageUrl: 'http://loca:3000/starry-night.jpg', dims: '114.3 x 91.44 cm', price: '$550', medium: 'Painting - Oil on canvas' },
    { id: 2, title: 'Salutary Failures', year: 2020, desc: RaphaelHefti, artist: sampleArtists[1], imageUrl: 'http://172.22.0.2:3000/mona-lisa.jpg', dims: '114.3 x 91.44 cm', price: 'Not for sale', medium: 'Painting - Oil on canvas' },
    { id: 3, title: 'L\'Arc de  Triomphe, Wrapped', year: 1961-2021, desc: LArcDeTriompheWrapped, artist: sampleArtists[2], imageUrl: 'http://172.22.0.2:3000/starry-night.jpg',  dims: '', price: 'Free entrance', medium: 'Exhibition in Paris' },
    { id: 4, title: 'The Bedroom', year: 1658, desc: TheBedroom, artist: sampleArtists[3], imageUrl: 'http://172.22.0.2:3000/mona-lisa.jpg',  dims: '51 x 60 cm', price: '$1200', medium: 'Painting - Oil on canvas'}
  ];
